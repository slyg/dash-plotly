...
query = {
    "query": """
     SELECT c.id, c.build_tag, c.job_name, c.build_id, c.current_build_current_result, c.correlation_id, c.current_build_duration, c.stage_timestamp, c._ts, c.current_build_scheduled_time
     FROM c
